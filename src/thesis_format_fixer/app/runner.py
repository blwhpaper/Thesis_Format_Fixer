...
def _run_single(
    ...
    *,
    ...
    artifact_paths = {
        "input_file": str(input_file),
        "fixed_docx": str(output_docx) if output_docx is not None else "(not generated)",
        "technical_report_json": str(final_json_out) if final_json_out is not None else "(not generated)",
        "technical_report_md": str(final_md_out) if final_md_out is not None else "(not generated)",
    ...
    payload["artifacts"] = {
        ...
        "technical_report_md": str(final_md_out) if final_md_out is not None else None,
